...
#ifndef CFLAT_CORE_COLLECTIONS_ENUMERABLE_SINGLEOBJECT_H
#define CFLAT_CORE_COLLECTIONS_ENUMERABLE_SINGLEOBJECT_H
...
/// single <see cref="Object"/> as if it were part of a collection.
///
...
internal struct IEnumerable *SingleObjectEnumerable_New(Object *item);
