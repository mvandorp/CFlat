...
#ifndef CFLAT_CORE_COLLECTIONS_ENUMERABLE_SINGLEPOINTER_ENUMERATOR_H
#define CFLAT_CORE_COLLECTIONS_ENUMERABLE_SINGLEPOINTER_ENUMERATOR_H
...
/// <see cref="SinglePointer"/>.
///
/// The lifetime of the <see cref="IEnumerator"/> should be managed with retain() and release().
/// </summary>
/// <param name="enumerable">Pointer to a <see cref="SinglePointer"/>.</param>
...
internal struct IEnumerator *SinglePointerEnumerator_New(const struct SinglePointer *enumerable);
