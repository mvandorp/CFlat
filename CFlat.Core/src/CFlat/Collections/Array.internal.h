...
#ifndef CFLAT_CORE_COLLECTIONS_ARRAY_INTERNAL_H
#define CFLAT_CORE_COLLECTIONS_ARRAY_INTERNAL_H

#ifndef CFLAT_CORE_COLLECTIONS_ARRAY_H
 #error Array.internal.h should not be included directly.
#endif
...
///     <paramref name="elementSize"/> is 0.
/// </exception>
