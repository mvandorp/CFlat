...
namespace CFlat {
    ...
    private:
        ...
        /// </summary>
        shared_ptr<const char[]> _value;

        String Trim(const char *trimChars, int mode) const;

        String TrimWhiteSpace(int mode) const;
    ...
    public:
        ...
        /* Constructors */
        /// <summary>
        /// Initializes an empty <see cref="String"/>.
        /// </summary>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String();
        
        String(shared_ptr<const char[]> value);

        // TODO: Test const stuff
        String(unique_ptr<char[]> &&value);
        ...
        /// </exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String(const char *value, uintsize startIndex, uintsize length);
        ...
        /// </exception>
        char GetCharAt(uintsize index) const;
        ...
        ///     Greater than zero if <paramref name="str1"/> follows <paramref name="str2"/> in the sort order.
        /// </returns>
        static int Compare(const String &str1, const String &str2, bool ignoreCase);
        ...
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        static String Concat(const String strings[], uintsize count);
        ...
        /// <exception cref="::ArgumentNullException"><paramref name="strings"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        static String Concat(const IEnumerable<String> &strings);
        ...
        ///     <see cref="null"/>, the method returns <see cref="true"/>.
        /// </returns>
        static bool Equals(const String &str1, const String &str2, bool ignoreCase);
        ...
        ///     <see cref="null"/>, the method returns <see cref="true"/>.
        /// </returns>
        static bool Equals(const String &str1, const char *str2);
        ...
        ///     <see cref="null"/>, the method returns <see cref="true"/>.
        /// </returns>
        static bool Equals(const String &str1, const char *str2, bool ignoreCase);
        ...
        /// <exception cref="::FormatException"><paramref name="format"/> is invalid.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        static String FormatVA(const char *format, VarArgsList args);
        ...
        /// <exception cref="::FormatException"><paramref name="format"/> is invalid.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        static String FormatVA(const String &format, VarArgsList args);
        ...
        /// </returns>
        /// <exception cref="::ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        uintsize IndexOf(char value) const;
        ...
        /// </exception>
        uintsize IndexOf(char value, uintsize startIndex) const;
        ...
        ///     <paramref name="startIndex"/> + <paramref name="count"/> is greater than the length of <paramref name="str"/>.
        /// </exception>
        uintsize IndexOf(char value, uintsize startIndex, uintsize count) const;
        ...
        ///     <paramref name="value"/> is <see cref="null"/>.
        /// </exception>
        uintsize IndexOf(const char *value) const;
        ...
        ///     <paramref name="startIndex"/> is greater than the length of <paramref name="str"/>.
        /// </exception>
        uintsize IndexOf(const char *value, uintsize startIndex) const;
        ...
        ///     <paramref name="startIndex"/> + <paramref name="count"/> is greater than the length of <paramref name="str"/>.
        /// </exception>
        uintsize IndexOf(const char *value, uintsize startIndex, uintsize count) const;
        ...
        ///     <paramref name="value"/> is <see cref="null"/>.
        /// </exception>
        uintsize IndexOf(const String &value) const;
        ...
        ///     <paramref name="startIndex"/> is greater than the length of <paramref name="str"/>.
        /// </exception>
        uintsize IndexOf(const String &value, uintsize startIndex) const;
        ...
        ///     <paramref name="startIndex"/> + <paramref name="count"/> is greater than the length of <paramref name="str"/>.
        /// </exception>
        uintsize IndexOf(const String &value, uintsize startIndex, uintsize count) const;
        ...
        /// </exception>
        uintsize IndexOfAny(const char *anyOf) const;
        ...
        ///     <paramref name="startIndex"/> is greater than the length of <paramref name="str"/>.
        /// </exception>
        uintsize IndexOfAny(const char *anyOf, uintsize startIndex) const;
        ...
        ///     <paramref name="startIndex"/> + <paramref name="count"/> is greater than the length of <paramref name="str"/>.
        /// </exception>
        uintsize IndexOfAny(const char *anyOf, uintsize startIndex, uintsize count) const;
        ...
        /// </exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String Insert(uintsize startIndex, const String &value) const;
        ...
        /// <exception cref="::ArgumentNullException"><paramref name="strings"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        static String Join(const String &separator, const String strings[], uintsize count);
        ...
        /// <exception cref="::ArgumentNullException"><paramref name="strings"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        static String Join(const String &separator, const IEnumerable<String> &strings);
        ...
        /// </returns>
        /// <exception cref="::ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        uintsize LastIndexOf(char value) const;
        ...
        /// </exception>
        uintsize LastIndexOf(char value, uintsize startIndex) const;
        ...
        ///     than 0.
        /// </exception>
        uintsize LastIndexOf(char value, uintsize startIndex, uintsize count) const;
        ...
        ///     <paramref name="value"/> is <see cref="null"/>.
        /// </exception>
        uintsize LastIndexOf(const char *value) const;
        ...
        ///     of <paramref name="str"/>.
        /// </exception>
        uintsize LastIndexOf(const char *value, uintsize startIndex) const;
        ...
        ///     <paramref name="value"/> is <see cref="null"/>.
        /// </exception>
        uintsize LastIndexOf(const String &value) const;
        ...
        ///     of <paramref name="str"/>.
        /// </exception>
        uintsize LastIndexOf(const String &value, uintsize startIndex) const;
        ...
        ///     <paramref name="anyOf"/> is <see cref="null"/>.
        /// </exception>
        uintsize LastIndexOfAny(const char *anyOf) const;
        ...
        ///     of <paramref name="str"/>.
        /// </exception>
        uintsize LastIndexOfAny(const char *anyOf, uintsize startIndex) const;
        ...
        ///     than 0.
        /// </exception>
        uintsize LastIndexOfAny(const char *anyOf, uintsize startIndex, uintsize count) const;
        ...
        /// <exception cref="ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String PadLeft(uintsize totalWidth, char paddingChar) const;
        ...
        /// <exception cref="ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String PadRight(uintsize totalWidth, char paddingChar) const;
        ...
        /// </exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String Remove(uintsize startIndex) const;
        ...
        /// </exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String Remove(uintsize startIndex, uintsize count) const;
        ...
        /// </exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String Replace(const char *oldValue, const char *newValue) const;
        ...
        /// <exception cref="::ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        unique_ptr<IList<String>> Split(const char *separators) const;
        ...
        /// <exception cref="::ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        unique_ptr<IList<String>> Split(const char *separators, uintsize count) const;
        ...
        /// <exception cref="::ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        unique_ptr<IList<String>> Split(const char *separators, StringSplitOptions options) const;
        ...
        /// </exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String Substring(uintsize startIndex) const;
        ...
        /// </exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        String Substring(uintsize startIndex, uintsize length) const;
        ...
        static unique_ptr<String> WrapPointer(const char *str);
        ...
        /// <exception cref="::ArgumentNullException"><paramref name="str"/> is <see cref="null"/>.</exception>
        unique_ptr<IEnumerator<char>> GetEnumerator() const override;
    };
