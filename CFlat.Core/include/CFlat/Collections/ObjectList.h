...
/// <returns>A pointer to the newly allocated <see cref="ObjectList"/>.</returns>
/// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
ObjectList *ObjectList_New_WithCapacity(uintsize capacity);
...
/// <exception cref="::ArgumentNullException"><paramref name="list"/> is <see cref="null"/>.</exception>
/// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
void ObjectList_Constructor_WithCapacity(ObjectList *list, uintsize capacity);
...
/// <exception cref="::ArgumentNullException"><paramref name="list"/> is <see cref="null"/>.</exception>
uintsize ObjectList_GetCapacity(const ObjectList *list);
...
/// </exception>
/// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
void ObjectList_SetCapacity(ObjectList *list, uintsize capacity);
...
/// </exception>
/// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
void ObjectList_InsertRange(ObjectList *list, uintsize index, const struct IEnumerable *collection);
...
///     <paramref name="list"/>.
/// </exception>
void ObjectList_RemoveRange(ObjectList *list, uintsize index, uintsize count);
...
/// <summary>
/// Sets the capacity to the actual number of elements in the <see cref="ObjectList"/>, if that number is less than a
/// treshold value.
/// </summary>
/// <param name="list">Object to a <see cref="ObjectList"/>.</param>
/// <exception cref="::ArgumentNullException"><paramref name="list"/> is <see cref="null"/>.</exception>
...
/// <exception cref="::ArgumentNullException"><paramref name="list"/> is <see cref="null"/>.</exception>
uintsize ObjectList_GetCount(const ObjectList *list);
...
/// </exception>
void *ObjectList_GetItem(const ObjectList *list, uintsize index);
...
///     <paramref name="index"/> is equal to or greater than the number of elements in <paramref name="list"/>.
/// </exception>
void ObjectList_SetItem(ObjectList *list, uintsize index, const void *item);
...
/// <exception cref="::ArgumentNullException"><paramref name="list"/> is <see cref="null"/>>.</exception>
uintsize ObjectList_IndexOf(const ObjectList *list, const void *item);
...
/// </exception>
/// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
void ObjectList_Insert(ObjectList *list, uintsize index, void *item);
...
///     <paramref name="index"/> is equal to or greater than the number of elements in <paramref name="list"/>.
/// </exception>
void ObjectList_RemoveAt(ObjectList *list, uintsize index);
