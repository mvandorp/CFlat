...
#ifndef CFLAT_CORE_COLLECTIONS_DICTIONARY_H
#define CFLAT_CORE_COLLECTIONS_DICTIONARY_H
...
#include "CFlat/Collections/IDictionary.h"
...
{
    /// <summary>
    /// Represents a dynamically sized list of objects. Implements <see cref="IDictionary"/>.
    /// </summary>
    ...
    private:
        ...
        public:
            inline Enumerator(const Dictionary<TKey, TValue> *dictionary) :
                _array(dictionary->_array),
                _listVersion(dictionary->_version),
            ...
            inline const KeyValuePair<TKey, TValue>& GetCurrent() const override
            {
                Validate_State(
    ...
    public:
        ...
        /* Constructors */
        /// <summary>
        /// Initializes a <see cref="Dictionary"/>.
        /// </summary>
        /// <param name="list">Pointer to an uninitialized <see cref="Dictionary"/>.</param>
        ...
        inline Dictionary() : Dictionary(4)
        {
        }

        inline Dictionary(const Dictionary<T> &list) : Dictionary(list._capacity)
        {
        ...
        inline Dictionary(Dictionary<T> &&list) :
            _array(nullptr),
            _capacity(0),
            _count(0),
        ...
        /// <summary>
        /// Initializes a <see cref="Dictionary"/> with the given capacity.
        /// </summary>
        /// <param name="list">Pointer to an uninitialized <see cref="Dictionary"/>.</param>
        /// <param name="elementSize">The size in bytes of each element.</param>
        /// <param name="equals">
        ///     An <see cref="EqualityPredicate"/> that is used to check elements for equality, or <see cref="null"/>.
        /// </param>
        /// <param name="capacity">The initial capacity of the <see cref="Dictionary"/>.</param>
        /// <exception cref="::ArgumentOutOfRangeException"><paramref name="elementSize"/> is 0.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        inline Dictionary(uintsize capacity) :
            _array(nullptr),
            _capacity(0),
            _count(0),
            _version(new uintsize(0))
        ...
        /// <summary>
        /// Initializes a <see cref="Dictionary"/> that contains the elements copied from the given collection.
        /// </summary>
        /// <param name="list">Pointer to an uninitialized <see cref="Dictionary"/>.</param>
        /// <param name="elementSize">The size in bytes of each element.</param>
        /// <param name="equals">
        ...
        /// <exception cref="::ArgumentOutOfRangeException"><paramref name="elementSize"/> is 0.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        inline Dictionary(const IEnumerable<T> &collection) : Dictionary()
        {
        ...
        /// <exception cref="::ArgumentOutOfRangeException"><paramref name="elementSize"/> is 0.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        inline Dictionary(const ICollection<T> &collection) : Dictionary(collection.GetCount())
        {
            this->AddRange(collection);
        }
        ...
        /* Destructor */
        /// <summary>
        /// Destroys a <see cref="Dictionary"/>.
        /// </summary>
        inline virtual ~Dictionary()
        {
        }

        inline Dictionary &operator=(const Dictionary<T> &list)
        {
        ...
        inline Dictionary &operator=(Dictionary<T> &&list)
        {
            if (this != std::addressof(list)) {
                std::swap(_array, list._array);
                std::swap(_capacity, list._capacity);
        ...
        /* Properties */
        /// <summary>
        /// Gets the capacity of a <see cref="Dictionary"/>.
        /// </summary>
        /// <returns>The capacity of the <see cref="Dictionary"/>.</returns>
        ...
        /// <summary>
        /// Sets the capacity of a <see cref="Dictionary"/>.
        /// </summary>
        /// <param name="capacity">The new capacity of the <see cref="Dictionary"/>.</param>
        ...
        /* Methods */
        /// <summary>
        /// Determines whether a <see cref="Dictionary"/> contains the given value.
        /// </summary>
        /// <param name="list">Pointer to a <see cref="Dictionary"/>.</param>
        ...
        /// <summary>
        /// Adds the elements of the given collection to the end of a <see cref="Dictionary"/>.
        /// </summary>
        /// <param name="collection">
        ///     Pointer to an <see cref="IEnumerable"/> whose elements should be added to the end of the <see cref="Dictionary"/>.
        /// </param>
        /// <exception cref="::ArgumentNullException"><paramref name="collection"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        ...
        /// <summary>
        /// Inserts the elements of the given collection into a <see cref="Dictionary"/> at the given index.
        /// </summary>
        /// <param name="index">The position where the new elements should be inserted.</param>
        /// <param name="collection">
        ///     Pointer to an <see cref="IEnumerable"/> whose elements should be inserted into the <see cref="Dictionary"/>.
        /// </param>
        /// <exception cref="::ArgumentNullException"><paramref name="collection"/> is <see cref="null"/>.</exception>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        inline void InsertRange(uintsize index, const IEnumerable<T> &collection)
        {
            Validate_ArgumentRange(index <= _count,
                "Index must be within the bounds of the Dictionary.", "index");
        ...
        /// <summary>
        /// Removes the given range of elements from the a <see cref="Dictionary"/>.
        /// </summary>
        ...
        /// <summary>
        /// Copies the elements of a <see cref="Dictionary"/> to the given array.
        /// </summary>
        /// <param name="destination">
        ///     The array that is the destination of the elements copied from the <see cref="Dictionary"/>.
        /// </param>
        /// <exception cref="::ArgumentNullException">
        ///     <paramref name="list"/> is <see cref="null"/> <b>-or-</b>
        ...
        /// <summary>
        /// Copies the elements of a <see cref="Dictionary"/> to a new array.
        /// </summary>
        ...
        /// <summary>
        /// Sets the capacity to the actual number of elements in the <see cref="Dictionary"/>, if that number is less than a treshold
        /// value.
        /// </summary>
        /// <exception cref="::OutOfMemoryException">There is insufficient memory available.</exception>
        ...
        /* IEnumerable */
        /// <summary>
        /// Returns a pointer to an <see cref="IEnumerator"/> that iterates through the given <see cref="Dictionary"/>.
        /// </summary>
        /// <returns>An <see cref="IEnumerator"/> that iterates through a <see cref="Dictionary"/>.</returns>
        inline unique_ptr<IEnumerator<T>> GetEnumerator() const override
        {
            return unique_ptr<IEnumerator<T>>(new Dictionary<T>::Enumerator(this));
        }

        /* ICollection */
        /// <summary>
        /// Gets the number of elements in a <see cref="Dictionary"/>.
        /// </summary>
        /// <returns>The number of elements in the <see cref="Dictionary"/>.</returns>
        ...
        /// <summary>
        /// Adds an item to a <see cref="Dictionary"/>.
        /// </summary>
        /// <param name="list">Pointer to a <see cref="Dictionary"/>.</param>
        ...
        /// <summary>
        /// Removes all elements from a <see cref="Dictionary"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes the first occurance of the given item from a <see cref="Dictionary"/>.
        /// </summary>
        /// <param name="list">Pointer to a <see cref="Dictionary"/>.</param>
        ...
        /* IDictionary */
        /// <summary>
        /// Gets the item at the given index of a <see cref="Dictionary"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>The item at the given index of the <see cref="Dictionary"/>.</returns>
        ...
        {
            Validate_ArgumentRange(index < _count, "Index must be within the bounds of the Dictionary.", "index");
        ...
        /// <summary>
        /// Determines the index of the given item in a <see cref="Dictionary"/>.
        /// </summary>
        /// <param name="list">Pointer to a <see cref="Dictionary"/>.</param>
        /// <param name="item">The item to find.</param>
        ...
        /// <summary>
        /// Inserts an item into a <see cref="Dictionary"/> at the given index.
        /// </summary>
        /// <param name="list">Pointer to a <see cref="Dictionary"/>.</param>
        ...
        /// <summary>
        /// Removes the element at the given index of a <see cref="Dictionary"/>.
        /// </summary>
